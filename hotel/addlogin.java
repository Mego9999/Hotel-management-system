...
public class addlogin extends JFrame implements ActionListener{
    ...
    addlogin(){
        ...
        ShowPassword.setFont(new Font("serif",Font.BOLD,10));
        ShowPassword.setBounds(150,100,70,20);
    ...
    public void actionPerformed(ActionEvent ae){
         ...
         try{
             ...
             if ("adminmaneger".equals(u) && "54321".equals(v)) 
            {
               String q = "select * from manger where username='"+u+"' and password='"+v+"'";
